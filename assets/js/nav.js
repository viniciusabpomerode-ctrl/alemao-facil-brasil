...
function renderNav(active) {
  ...
  const links = [
    ...
    { href: "escrita.html", label: "Escrita", key: "escrita" },
    { href: "jogo.html", label: "Jogo", key: "jogo" },
    { href: "expressoes.html", label: "Expressões", key: "expressoes" },
...
document.getElementById("tl-name").onclick=()=>{tray.classList.add("hidden");lofi.classList.remove("hidden")};
lp.onclick=(e)=>{e.stopPropagation();tray.classList.add("hidden");const f=lofiFrame;if(f.style.bottom==="-9999px")lofiPlay();else lofiPause()};
